...
all_files_new <- lapply(patient_id_list, merge_pred_eval, pred_dir, eval_dir, outdir)
...
all_files_newThreshold_new <- lapply(patient_id_list, merge_pred_eval_newThreshold, pred_dir, eval_dir, outdir)
